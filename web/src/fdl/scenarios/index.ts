...
export const SCENARIOS: ScenarioMeta[] = [
  /* ─── 1. Card Payment (from spec — real bidirectional flow) ─── */
  {
    id: 'card-payment',
    title: 'Card payment',
    subtitle: 'Checkout → merchant → auth chain → settlement net of fees',
    flow: {
      id: 'card-payment',
      ...
      nodes: [
        ...
        { id: 'nmerch', kind: 'payment', label: 'E-Commerce Merchant' },
      ...
      edges: [
        ...
        { id: 'e0', source: S, target: 'nmerch', label: 'checkout' },
        { id: 'e1', source: 'nmerch', target: 'ngw', label: 'card data' },
        { id: 'e2', source: 'ngw', target: 'nproc' },
        { id: 'e3', source: 'nproc', target: 'nacq' },
        { id: 'e4', source: 'nacq', target: 'nnet' },
        { id: 'e5', source: 'nnet', target: 'niss' },
        /* Backward response path */
        { id: 'e6', source: 'niss', target: 'nnet', label: 'response' },
        { id: 'e7', source: 'nnet', target: 'nacq', label: 'relay' },
        { id: 'e8', source: 'nacq', target: 'nproc', label: 'settlement' },
        { id: 'e9', source: 'nproc', target: 'ngw', label: 'relay' },
        { id: 'e10', source: 'ngw', target: 'nmerch', label: 'relay' },
        { id: 'e11', source: 'nmerch', target: E, label: 'result' },
      ],
      simulation: multiCase(800, [
        {
          id: 'approved',
          label: '✓ Approved — balance OK, no risk',
          context: 'Customer pays $100.00 at an e-commerce merchant — Visa ****4242',
          sequence: [
            S,
            'nmerch',
            'ngw',
          ...
          edgePayloads: {
            e0: 'checkout · $100.00',
            e1: 'PAN ****4242 · $100.00',
            e2: 'AUTH_REQ · $100.00 · MID-8821',
            e3: 'ISO 8583 · 0100 · $100.00',
            e4: 'AUTH · BIN 424242 · $100.00',
            e5: 'AUTH_REQ · $100.00',
            e6: 'RSP 00 · Approved',
            e7: 'AUTH_RSP · Approved · $100.00',
            e8: 'SETTLE · $96.80 net · fee $3.20',
            e9: 'RSP 00 · ref:TXN-7842',
            e10: 'APPROVED · ref:TXN-7842',
            e11: '✓ $100.00 captured',
          },
        },
        {
          ...
          context: 'Customer attempts $100.00 purchase — account balance is $42.00',
          sequence: [
            S,
            'nmerch',
            'ngw',
          ...
          failureMessages: {
            niss: 'Balance check failed — $42.00 available, $100.00 requested',
            ...
            nmerch: 'Checkout voided — insufficient funds',
            [E]: 'Payment declined',
          },
          edgePayloads: {
            e0: 'checkout · $100.00',
            ...
            e4: 'AUTH · BIN 424242 · $100.00',
            e5: 'AUTH_REQ · $100.00',
            e6: 'RSP 51 · Insufficient funds',
            e7: 'DECLINE · code 51 · $100.00',
            e8: 'DECLINED · ref:TXN-7842',
            e9: 'DECLINE · insufficient funds',
            e10: 'DECLINE · notifying merchant',
            e11: '✗ $100.00 declined',
          },
        },
        {
          ...
          context: 'Customer attempts $100.00 purchase — flagged by fraud detection',
          sequence: [
            S,
            'nmerch',
            'ngw',
          ...
          failureMessages: {
            ...
            nmerch: 'Checkout blocked — risk hold',
            [E]: 'Payment blocked',
          },
          edgePayloads: {
            e0: 'checkout · $100.00',
            ...
            e4: 'AUTH · BIN 424242 · $100.00',
            e5: 'AUTH_REQ · $100.00',
            e6: 'RSP 59 · Suspected fraud',
            e7: 'DECLINE · code 59 · $100.00',
            e8: 'DECLINED · ref:TXN-7842',
            e9: 'DECLINE · risk flagged',
            e10: 'DECLINE · notifying merchant',
            e11: '✗ $100.00 blocked',
          },
        },
